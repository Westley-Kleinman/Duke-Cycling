        ...
        <div className="container">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Link 
                href="/rides/submit" 
                className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-6 rounded-xl text-base transition-all duration-200 transform hover:scale-105 hover:shadow-xl"
              >
                Submit a Ride
              </Link>
              <Link 
                href="/calendar" 
                className="bg-white text-blue-700 font-bold py-3 px-6 rounded-xl text-base border-2 border-slate-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 transform hover:scale-105"
              >
                View Calendar
              </Link>
              <a 
